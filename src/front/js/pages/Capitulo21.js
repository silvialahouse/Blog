...
const Capitulo21 = () => {
    ...
    const handleVerification = () => {
        if (inputValue.toLowerCase() === "paleta") {
            Swal.fire({
                title: "¡CORRECTO!",
                icon: "success",
    ...
    return (
        <div className="capitulo-container">
            ...
            <img src="https://media.istockphoto.com/id/157683890/es/foto/pintor-de-paleta.jpg?s=612x612&w=0&k=20&c=DILG3nBA2SWThGw--1Q8xrYQ9NKW8v52DNGyfbS3c3c=" alt="Imagen del Capítulo 1" className="imagen-capitulo" />
