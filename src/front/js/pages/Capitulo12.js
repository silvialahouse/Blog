...
const Capitulo12 = () => {
    ...
    const handleVerification = () => {
        if (inputValue.toLowerCase() === "pierna") {
            Swal.fire({
                title: "¡CORRECTO!",
                icon: "success",
    ...
    return (
        <div className="capitulo-container">
            ...
            <img src="https://www.esalud.com/wp-content/uploads/2019/06/musculos-pierna.jpg" alt="Imagen del Capítulo 1" className="imagen-capitulo" />
