...
const Capitulo13 = () => {
    ...
    const handleVerification = () => {
        if (inputValue.toLowerCase() === "cueva") {
            Swal.fire({
                title: "¡CORRECTO!",
                icon: "success",
    ...
    return (
        <div className="capitulo-container">
            ...
            <img src="https://www.monapart.com/sites/default/files/styles/scale_960x960_/public/mediabrowser/cueva-prehistoria.jpg?itok=bx37ndWV" alt="Imagen del Capítulo 1" className="imagen-capitulo" />
