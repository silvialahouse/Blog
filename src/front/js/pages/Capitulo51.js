...
const Capitulo51 = () => {
    ...
    const handleVerification = () => {
        if (inputValue.toLowerCase() === "avion") {
            Swal.fire({
                title: "¡CORRECTO!",
                icon: "success",
    ...
    return (
        <div className="capitulo-container">
            ...
            <img src="https://i.blogs.es/ce505a/airbus-1a321xlr-1/1366_2000.jpeg" alt="Imagen del Capítulo 1" className="imagen-capitulo" />
