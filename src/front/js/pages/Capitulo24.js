...
const Capitulo24 = () => {
    ...
    const handleVerification = () => {
        if (inputValue.toLowerCase() === "caballete") {
            Swal.fire({
                title: "¡CORRECTO!",
                icon: "success",
    ...
    return (
        <div className="capitulo-container">
            ...
            <img src="https://www.shutterstock.com/image-photo/wooden-easel-blank-canvas-on-600nw-2332856331.jpg" alt="Imagen del Capítulo 1" className="imagen-capitulo" />
