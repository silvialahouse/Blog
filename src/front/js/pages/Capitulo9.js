...
const Capitulo9 = () => {
    ...
    const handleVerification = () => {
        if (inputValue.toLowerCase() === "corazon") {
            Swal.fire({
                title: "¡CORRECTO!",
                icon: "success",
    ...
    return (
        <div className="capitulo-container">
            ...
            <img src="https://www.siacardio.com/wp-content/uploads/2019/04/inmne.jpg" alt="Imagen del Capítulo 1" className="imagen-capitulo" />
